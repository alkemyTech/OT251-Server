...
public class OrganizationServiceImpl implements IOrganizationService{
    ...
    public OrganizationResponse update(UUID id, OrganizationRequest organizationDTO) {
        orgRepo.findById(id).orElseThrow(() -> new ResourceNotFoundException("OrganizationModel", "id", id));
        Organization organization = organizationMapper.organizationRequestToEntity(organizationDTO);
        return organizationMapper.organizationToOrganizationDTO(orgRepo.save(organization));
    }
    ...
    public OrganizationResponse getPublicInfo(){
        ...
        OrganizationResponse organizationResponse = organizationMapper.organizationToOrganizationDTO(organization);
